...
function get_depurar_totales(arr, tutorizado) {
    var out = {};
    var out_p = new Array();
...
function update_reporte_indicador(data) {
    ...
    $('.pinta_resumen').html(
            "<center>" +
            '<div class="col-sm-4"><strong>Número de encuestas</strong><br><div id="div_total_encuestas">' + data.total_general + '</div></div>' +
