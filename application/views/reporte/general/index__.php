<?php exit();
$url_control = "site_url+'/reporte_general/get_buscar_cursos_encuestas', '#form_reporte_general', '#listado_resultado_general'";
echo js("busquedas/busqueda.js");---
echo form_open('reporte_bonos/index', array('id' => 'form_reporte_general'));
?>
<div class="row">
...
//                                        'readonly'=>'readonly',
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-4">
                        <div class="panel-body input-group input-group-sm">
                            ...
                            <?php // echo $this->form_complete->create_element(array('id'=>'per_page', 'type'=>'dropdown', 'options'=>array(2=>2,3=>3,4=>4,10=>10, 20=>20, 50=>50, 100=>100), 'attributes'=>array('class'=>'form-control', 'placeholder'=>'Número de registros a mostrar', 'data-toggle'=>'tooltip', 'data-placement'=>'top', 'title'=>'Número de registros a mostrar', 'onchange'=>"data_ajax(site_url+'/bonos_titular/get_buscar_cursos_encuestas', '#form_buscador', '#listado_resultado_general')")));     ?>
                ...
                <div id="listado_resultado_general">
...
$(document).ready(function () {
    data_ajax(site_url + "/reporte_bonos/get_buscar_cursos_encuestas", "#form_reporte_general", "#listado_resultado_general");
});
</script>